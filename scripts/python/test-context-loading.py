...
def check_selection(module) -> None:
    try:
        ...
        cases = [
            ...
            ('design', 'full', 'verification', ['state', 'cross-system'], []),
            ('prd', None, 'plan', [], []),
            ('prd', None, 'module', ['scenes'], ['complex-action', 'action-body']),
            ('prd', None, 'integration', [], []),
            ('prd', None, 'verification', [], []),
        ]
        ...
        authorized_cases = [
            ...
            ('module-verifier', 'prd', None, 'verification'),
        ]
        ...
        unauthorized_cases = [
            ...
            ('prd-module-writer', 'prd', None, 'verification'),
            ('module-verifier', 'prd', None, 'module'),
        ]
...
def main() -> int:
    ...
    if FAILURES:
        ...
        for item in FAILURES:
            print(f'- {item}')
        return 1
    print('上下文装载测试通过：manifest、章节标记、来源、选择去重和产品边界均正常')
    return 0
