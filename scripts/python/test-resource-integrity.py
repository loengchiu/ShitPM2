...
def check_context_manifest() -> None:
    ...
    for rel in ("scripts/python/context-pack.py", "scripts/python/source-index.py", "scripts/python/context-runtime-check.py", "scripts/python/token_estimate.py", "scripts/python/test-context-loading.py", "scripts/python/test-context-runtime.py"):
...
def test_resource_integrity() -> None:
    assert main() == 0
