import { Button, Card, Col, DatePicker, Form, Input, InputNumber, Radio, Row, Select, Space, Steps, Typography } from 'antd';
import { ArrowLeftOutlined, CloseOutlined, ReloadOutlined, SendOutlined } from '@ant-design/icons';
  ...
  return (
    <div>
      ...
      <div className="page-action-bar">
        ...
        <Button type="primary" icon={<SendOutlined />}>提交申请</Button>
      </div>
    </div>
  );
}
